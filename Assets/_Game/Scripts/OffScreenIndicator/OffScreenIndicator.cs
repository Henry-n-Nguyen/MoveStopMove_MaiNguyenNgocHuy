...
public class OffScreenIndicator : MonoBehaviour
{
    ...
    void DrawIndicators()
    {
        ...
        {
            Vector3 screenPosition = OffScreenIndicatorCore.GetScreenPosition(mainCamera, target.transform.position + Vector3.up * 3f);
            bool isTargetVisible = OffScreenIndicatorCore.IsTargetVisible(screenPosition);
            int point = target.NeedPointText ? target.GetPoint() : -1;
